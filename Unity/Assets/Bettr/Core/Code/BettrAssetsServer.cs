...
{
    public delegate void GetAssetsCallback(string requestURL, byte[] payload, bool success, string error);
    
    public class BettrAssetsServer
    {
        public string ServerBaseURL { get; private set; }
        
        public BettrAssetsServer(string serverBaseURL)
        {
        ...
        public IEnumerator Get(string requestUri, GetAssetsCallback callback)
        {
